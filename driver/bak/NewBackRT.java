...
public void exitFrac(uebMathParser.FracContext ctx) {
   int cnt = ctx.getChildCount();
    System.out.println( "   ====>ExiFrac, child cnt: "+cnt);

    String ink = conCat( ctx, "rrac", true );
...
//        SINGLE LETTERS NOT ACTING AS CONTRACTIONS, Etc.
@Override 
...
System.out.println( "ExitWord, cnt: "+cnt" expr2Count: "+ expr2Count);
