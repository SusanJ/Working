...
@Override 
public void exitNemethStartDisplay(uebMathParser.NemethStartDisplayContext ctx) { 
...
@Override 
public void exitNemethStartInline(uebMathParser.NemethStartInlineContext ctx) { 
 System.out.println( "\n  Nemeth Start Display Indicator" );
 String brl = ctx.getText();
 System.out.println( "Nem indicator--brl: |"+brl+"|" );
  //Must be consistent with NemethIndicator braille, NOT parser
...
@Override 
 public void enterNemethGeneric(uebMathParser.NemethGenericContext ctx) { 
 System.out.println( "enter Nemeth Generic " );
 System.out.println( "  brl: |"+ctx.getText()+"|");
}
	
@Override 
 public void exitNemethGeneric(uebMathParser.NemethGenericContext ctx) { }

@Override
public void exitNemSyms(uebMathParser.NemSymsContext ctx) {
  System.out.println( "\n Nemeth Symbols" );
  String brl = ctx.getText();
...
@Override
 public void enterSymseq(uebMathParser.SymseqContext ctx) { 
 ...
 List<uebMathParser.NemethGenericContext> nemList = ctx.nemethGeneric();
 if (nemList == null){
...
@Override
 public void exitSymseq(uebMathParser.SymseqContext ctx) { 
...
@Override
 public void exitNumfrag(uebMathParser.NumfragContext ctx) {
  System.out.println( "\n          Translating Numfrag" );
...
@Override 
 public void exitCapsWordInd(uebMathParser.CapsWordIndContext ctx) {
...
@Override
 public void exitPreAlone(uebMathParser.PreAloneContext ctx) { 
     System.out.println(
...
@Override 
 public void exitSaLetters(uebMathParser.SaLettersContext ctx) {
...
@Override
 public void exitShortForms(uebMathParser.ShortFormsContext ctx) {
  if (traceStandingAloneWord){
...
@Override 
 public void exitPostAlone(uebMathParser.PostAloneContext ctx) { 
 System.out.println( "\n    ***exitPostAlone***" );
 String brl = ctx.getText();
    String ink =
...
@Override
 public void exitRootlessToken(uebMathParser.RootlessTokenContext ctx) { 
...
@Override 
 public void exitPr_token(uebMathParser.Pr_tokenContext ctx) { 
  if (inNemMath) return;
  System.out.println( "\n    ***starting exitPr***" );
...
// backtranslation
 @Override
 public void exitTrailingSep(uebMathParser.TrailingSepContext ctx) {
